...
public class OrOperation extends BasicBitmapOperation {

  String name = "||";

  public OrOperation(BitMapManager bmm) {
    super(bmm);
  }
  ...
  public AviatorObject call(Map<String, Object> env, AviatorObject arg1, AviatorObject arg2) {
    ...
    Future<Bitmap> future = manager.rawOp(new Bitmap[] { btm1, btm2 }, OPERATOR.or);
    while (true) {
      try {
