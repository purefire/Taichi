...
public class AndOperation extends BasicBitmapOperation {

  String name = "&&";

  public AndOperation(BitMapManager bmm) {
    super(bmm);
  }
  ...
  public AviatorObject call(Map<String, Object> env, AviatorObject arg1, AviatorObject arg2) {
    ...
    Future<Bitmap> future = manager.rawOp(new Bitmap[] { btm1, btm2 }, OPERATOR.and);
    while (true) {
      try {
